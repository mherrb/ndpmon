...
struct ip6_hdr* create_ip6_hdr(const struct in6_addr* dstaddr, const struct in6_addr* srcaddr) 
{
...
int compose_packet(const struct ether_addr* dst_mac, const struct ether_addr* src_mac, struct ip6_hdr* iphdr, struct icmp6_hdr* icmphdr, struct icmp_nd_opt_list* options, uint8_t** packet, int* packet_length) 
{
...
int compose_and_send_icmp_packet(char* interface, const struct ether_addr* dst_mac, const struct ether_addr* src_mac, struct ip6_hdr* iphdr, struct icmp6_hdr* icmphdr, struct icmp_nd_opt_list* options) 
{
